...
class Model(nn.Module):
    def __init__(self, n_embs, img_embs, n_hidden, vocab_size, dropout, max_len):
        ...
        self.word_embedding = WordEmbeddings(n_embs, vocab_size)
        self.position_embedding = ImgPositionEncoding(n_hidden, dropout, max_len=49)
    ...
    def encode_img(self, img):
        Img = img.view(img.size(0), img.size(1), -1) #[32, 2048, 49]
