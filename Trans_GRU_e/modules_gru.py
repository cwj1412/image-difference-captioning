...
class Model(nn.Module):
    def __init__(self, n_embs, img_embs, n_hidden, vocab_size, dropout, max_len=50):
        ...
        self.encoder = Transformer(img_embs=img_embs, n_embs=n_embs, dim_ff=n_hidden, n_head=8, n_block=1, dropout=dropout)
        # Images
    ...
    def encode_img(self, img1, img2):
        ...
        L = self.encoder(Img)
        G = torch.zeros(1,L.size(0),L.size(2))
        G = G.cuda()
        # print('G ', G.size())
        return G, L
