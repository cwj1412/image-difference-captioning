...
parser.add_argument('-n_block', type=int, default=1, help='block number')

parser.add_argument('-batch_size', type=int, default=32, help='Batch Size')
parser.add_argument('-epoch', type=int, default=100, help='Number of Epoch')
parser.add_argument('-report', type=int, default=50, help='Report interval')
parser.add_argument('-dropout', type=float, default=0.5, help='Dropout Rate')
parser.add_argument('-max_len', type=int, default=50, help='Max length of captions')
parser.add_argument('-lr', type=float, default=1e-4, help='Learning Rate')
parser.add_argument('-beam_size', type=int, default=1, help='Beam Size')

parser.add_argument('-data_path', type=str, default='/data2/wwy/caption/data/ImageEdit/')
            ...
            if count % args.report == 0 or count == total:
                ...
                if i > 1:
                    ...
                    if score > best_score:
                        ...
                        save_model(os.path.join(args.out_path, 'best_checkpoint_gitti_422_3.pt'), model)
                    else:
                        no_beat += 1
                        save_model(os.path.join(args.out_path, 'checkpoint_gitti_422_3.pt'), model)
