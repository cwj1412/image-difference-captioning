...
parser.add_argument('-n_block', type=int, default=2, help='block number')
...
parser.add_argument('-data_path', type=str, default='/data2/wwy/caption/data/spot/')
            ...
            if count % args.report == 0 or count == total:
                ...
                if i >= 0:
                    ...
                    if score > best_score:
                        ...
                        save_model(os.path.join(args.out_path, 'best_checkpoint_gitti_322_1.pt'), model)
                    else:
                        no_beat += 1
                        save_model(os.path.join(args.out_path, 'checkpoint_gitti_322_1.pt'), model)
